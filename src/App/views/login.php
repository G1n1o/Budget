                        ...
                        <div class="id">
                            <div class="input-icons">
                                ...
                                <div class="icon-center">
                                    <input value="<?= e($oldFormData['email'] ?? ''); ?>" class="input" name="email" type="email" id="email" <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
